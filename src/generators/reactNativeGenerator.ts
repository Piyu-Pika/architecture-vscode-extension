...
`
        ...
        await fs.writeFile(
            path.join(this.projectPath, 'src/layouts/MainLayout.tsx'),
            `import React from 'react';
...
`
        ...
        await fs.writeFile(
            path.join(this.projectPath, 'src/screens/HomeScreen.tsx'),
            `import React from 'react';
...
`
        ...
        await fs.writeFile(
            path.join(this.projectPath, 'src/screens/LoginScreen.tsx'),
            `import React from 'react';
import { View, Text, StyleSheet } from 'react-native';
...
`
        ...
        // Create Styles
        await fs.writeFile(
            path.join(this.projectPath, 'src/styles/global.ts'),
...
`
        ...
        await fs.writeFile(
            path.join(this.projectPath, 'src/styles/colors.ts'),
            `export const colors = {
  primary: '#007bff',
  secondary: '#6c757d',
  background: '#f8f8f8',
...
`
        ...
        // Create Types
        await fs.writeFile(
            path.join(this.projectPath, 'src/types/navigation.ts'),
