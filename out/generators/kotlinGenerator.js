...
class KotlinGenerator {
    ...
    async generate() {
        try {
            ...
            await fs.writeFile(buildGradlePath, this.createBuildGradle(kotlinPackage));
            // Create settings.gradle.kts
            const settingsGradlePath = path.join(basePath, 'settings.gradle.kts');
            await ensureDirForFile(settingsGradlePath);
            await fs.writeFile(settingsGradlePath, this.createSettingsGradle(kotlinPackage));
            ...
            await fs.writeFile(mainPath, this.createApplicationMain(kotlinPackage));
            ...
            await fs.writeFile(modelPath, this.createExampleModel(kotlinPackage));
            ...
            await fs.writeFile(serviceInterfacePath, this.createExampleServiceInterface(kotlinPackage));
            ...
            await fs.writeFile(serviceImplPath, this.createExampleServiceImpl(kotlinPackage));
            ...
            await fs.writeFile(repoPath, this.createExampleRepository(kotlinPackage));
            ...
            await fs.writeFile(controllerPath, this.createExampleController(kotlinPackage));
            ...
            await fs.writeFile(configPath, this.createAppConfig(kotlinPackage));
            // Create example test
            ...
            await fs.writeFile(testPath, this.createExampleServiceTest(kotlinPackage));
            ...
            await fs.writeFile(appConfigPath, this.createApplicationYaml());
            // Create README.md
            await this.createReadme(basePath, kotlinPackage);
            // Create .gitignore
            const gitignorePath = path.join(basePath, '.gitignore');
            await ensureDirForFile(gitignorePath);
            await fs.writeFile(gitignorePath, this.createGitignore());
...
`;
    ...
    createSettingsGradle(packageName) {
...
`;
    ...
    createApplicationMain(packageName) {
...
`;
    ...
    createExampleModel(packageName) {
...
`;
    ...
    createExampleServiceInterface(packageName) {
...
`;
    ...
    createExampleServiceImpl(packageName) {
        return `package com.example.${packageName}.domain.service
...
`;
    ...
    createExampleRepository(packageName) {
...
`;
    ...
    createExampleController(packageName) {
...
`;
    ...
    createExampleServiceTest(packageName) {
        return `package com.example.${packageName}.domain.service
...
`;
    ...
    async createReadme(basePath, packageName) {
