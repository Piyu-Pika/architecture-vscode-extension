...
class SpringBootGenerator {
    ...
    async generate() {
        ...
        await fs.writeFile(pomPath, `<?xml version="1.0" encoding="UTF-8"?>
...
`);
        ...
        await fs.writeFile(appPath, `package com.example.${this.projectName.toLowerCase()};
...
`);
        ...
        await fs.writeFile(modelPath, `package com.example.${this.projectName.toLowerCase()}.model;
...
`);
        ...
        await fs.writeFile(repoPath, `package com.example.${this.projectName.toLowerCase()}.repository;
...
`);
        ...
        await fs.writeFile(servicePath, `package com.example.${this.projectName.toLowerCase()}.service;
...
`);
        ...
        await fs.writeFile(controllerPath, `package com.example.${this.projectName.toLowerCase()}.controller;
...
`);
        ...
        await fs.writeFile(appPropsPath, `spring.application.name=${this.projectName.toLowerCase()}
...
`);
        ...
        await fs.writeFile(controllerTestPath, `package com.example.${this.projectName.toLowerCase()}.controller;
...
`);
        ...
        await fs.writeFile(gitignorePath, `# Maven
target/
*.log
...
exports.SpringBootGenerator = SpringBootGenerator;
//# sourceMappingURL=springbootGenerator.js.map