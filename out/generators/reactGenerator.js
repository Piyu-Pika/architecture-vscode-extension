...
`);
        await fs.writeFile(path.join(this.projectPath, 'src/components/Button/Button.module.scss'), `.button {
  padding: 10px 20px;
...
`);
        await fs.writeFile(path.join(this.projectPath, 'src/components/Modal/Modal.module.scss'), `.modal {
  position: fixed;
  top: 0;
  left: 0;
  width: 100%;
...
`);
        ...
        await fs.writeFile(path.join(this.projectPath, 'src/layouts/MainLayout/MainLayout.tsx'), `import React from 'react';
...
`);
        await fs.writeFile(path.join(this.projectPath, 'src/layouts/MainLayout/MainLayout.module.scss'), `.mainLayout {
  display: flex;
  flex-direction: column;
  min-height: 100vh;
}
`);
        await fs.writeFile(path.join(this.projectPath, 'src/layouts/MainLayout/index.ts'), `export { default } from './MainLayout';
`);
        // Create Layout: AuthLayout
        await fs.writeFile(path.join(this.projectPath, 'src/layouts/AuthLayout/AuthLayout.tsx'), `import React from 'react';
...
`);
        await fs.writeFile(path.join(this.projectPath, 'src/layouts/AuthLayout/AuthLayout.module.scss'), `.authLayout {
  display: flex;
...
`);
        await fs.writeFile(path.join(this.projectPath, 'src/layouts/AuthLayout/index.ts'), `export { default } from './AuthLayout';
`);
...
`);
        await fs.writeFile(path.join(this.projectPath, 'src/features/components/ProductList/ProductList.module.scss'), `.productList {
  padding: 20px;
}
`);
...
`);
        ...
        await fs.writeFile(path.join(this.projectPath, 'src/features/hooks/index.ts'), `// Export feature-specific hooks here
`);
...
`);
        await fs.writeFile(path.join(this.projectPath, 'src/users/components/UserProfile/UserProfile.module.scss'), `.userProfile {
  padding: 20px;
}
`);
...
`);
        ...
        await fs.writeFile(path.join(this.projectPath, 'src/users/hooks/index.ts'), `// Export user-specific hooks here
`);
...
`);
        // Create Routes
        await fs.writeFile(path.join(this.projectPath, 'src/routes/AppRoutes.tsx'), `import React from 'react';
...
`);
        await fs.writeFile(path.join(this.projectPath, 'src/routes/ProtectedRoute.tsx'), `import React from 'react';
...
`);
        await fs.writeFile(path.join(this.projectPath, 'src/routes/index.ts'), `export { default as AppRoutes } from './AppRoutes';
...
`);
        // Create Styles
        await fs.writeFile(path.join(this.projectPath, 'src/styles/variables.scss'), `$primary-color: #007bff;
`);
        await fs.writeFile(path.join(this.projectPath, 'src/styles/global.scss'), `body {
  margin: 0;
  font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Oxygen, Ubuntu, Cantarell, 'Open Sans', 'Helvetica Neue', sans-serif;
}
`);
        await fs.writeFile(path.join(this.projectPath, 'src/styles/mixins.scss'), `@mixin flex-center {
  display: flex;
  justify-content: center;
  align-items: center;
}
`);
        // Create Pages
        await fs.writeFile(path.join(this.projectPath, 'src/pages/HomePage.tsx'), `import React from 'react';
...
`);
        await fs.writeFile(path.join(this.projectPath, 'src/pages/LoginPage.tsx'), `import React from 'react';
...
`);
        await fs.writeFile(path.join(this.projectPath, 'src/pages/ProductPage.tsx'), `import React from 'react';
